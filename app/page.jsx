    ...
    return (<main className="min-h-screen bg-white px-4 py-8">
      <div className="mx-auto w-full max-w-6xl space-y-8">
        <section className="space-y-3 text-center">
          ...
          {uniqueThemes.length > 0 ? (<div className="flex flex-wrap justify-center gap-2 pt-2">
              {uniqueThemes.map((theme) => (<Link key={theme} href={`/niche/${theme}`} className="rounded-full bg-gray-100 px-3 py-1 text-xs text-gray-700 hover:bg-gray-200">
