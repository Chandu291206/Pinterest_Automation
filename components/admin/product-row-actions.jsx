...
export function ProductRowActions({ id, isActive }) {
    ...
    return (<div className="space-y-1">
      <div className="flex items-center gap-2">
        <Button size="sm" variant={isActive ? "secondary" : "default"} onClick={toggleActive} disabled={isUpdating || isDeleting}>
          {isUpdating ? "Saving..." : isActive ? "Set Inactive" : "Set Active"}
        </Button>
        <Button size="sm" variant="destructive" onClick={deleteProduct} disabled={isUpdating || isDeleting}>
